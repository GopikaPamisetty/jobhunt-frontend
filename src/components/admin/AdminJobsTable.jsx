...
//import { setAllAdminJobs } from '../../redux/jobSlice'; // adjust the path
                                ...
                                <TableCell className="text-right cursor-pointer">
                                    <Popover>
                                        ...
                                        <PopoverContent className="w-32">
                                            <div onClick={()=> navigate(`/admin/edit-job/${job._id}`)} className='flex items-center gap-2 w-fit cursor-pointer'>
                                                <Edit2 className='w-4' />
                                                <span>Edit</span>
                                            </div>
